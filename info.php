		...
		<div class="content">
			...
			<div class="frequently-asked-questions">
				...
				<div class="question-divider">
					...
					<p class="answer">The idea came from reading 
						"<a href="http://books.google.com/books?id=ILpgAAAAMAAJ">Mazes and Labyrinths</a>: A General Account of Their History and Developments".
						The book traces mazes far into the way back, and describes their intricate designs and structures in ways that show how each was relevant 
						to the time that it was created. I was wondering what the absolute most contemporary maze would look like? I set out to create a maze about as 
						2014-as-possible, and now there is this.
					</p>
				</div>
				<div class="question-divider">
					<p id="question">Do my changes affect the maze in real time?</p>
					<p class="answer">Not exactly. Anything you do on the <a href="make.php">make</a> or <a href="draw.php">draw</a> pages won't
				...
				<div class="question-divider">
					...
					<p class="answer">The Finder's Folder is sort of the equivalent to the treasure at the end of the maze. Unlike other 
