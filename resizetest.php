<?php
	...
	// 	$fileprefix = str_pad(strval($i), 4, "0", STR_PAD_LEFT);
	// 	$image->load($load_directory . "/test_image_" . $fileprefix . ".png");
	// 	$image->resize($size, $size);
	// 	$image->save($save_directory . "/test_image_" . $fileprefix . ".png", IMAGETYPE_PNG, 9);
	// }
?>